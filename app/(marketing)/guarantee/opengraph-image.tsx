...
export const alt = "Our promise, in writing — proof first, refund in full";

const HEADLINE = "OUR PROMISE, IN WRITING.";

export default async function Image() {
  const meta = pageFor("/guarantee");
    ...
    (
      <OgFrame tone="stock">
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          <div style={{ display: "flex", fontFamily: "Anton", fontSize: 88, lineHeight: 1, letterSpacing: -0.5, maxWidth: 940 }}>
            {HEADLINE}
          </div>
