...
export const alt = "About the studio — who is asking for your athlete's photos";

const HEADLINE = "WHO IS ASKING FOR YOUR ATHLETE'S PHOTOS.";

export default async function Image() {
  const meta = pageFor("/about");
