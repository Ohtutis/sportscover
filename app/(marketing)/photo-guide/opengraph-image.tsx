...
export const alt = "The photos that work — what the photo check looks for";

const HEADLINE = "THE PHOTOS THAT WORK.";

export default async function Image() {
  const meta = pageFor("/photo-guide");
    ...
    (
      <OgFrame tone="stock">
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          <div style={{ display: "flex", fontFamily: "Anton", fontSize: 92, lineHeight: 1, letterSpacing: -0.5, maxWidth: 940 }}>
            {HEADLINE}
          </div>
