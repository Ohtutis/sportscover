...
export const packages = [
  ...
  },
  {
    ...
    features: [
      ...
      "25 double-sided 2.5×3.5-inch trading cards",
      "Premium 16 pt cardstock + rounded corners",
...
export const addOns = [
  ...
  ["Extra pack of 25 cards", "+$39", "Same athlete and approved card design."],
...
export const faqItems = [
  ...
  ["Are the trading cards real physical cards?", "Yes. Physical packages include 25 double-sided personalized trading cards printed at standard 2.5×3.5-inch collector-card size with premium 16 pt cardstock and rounded corners."],
  ["Why are there 25 trading cards?", "A pack gives the athlete enough cards to keep, collect, and share with family, teammates, and coaches. Additional packs can be ordered using the same approved design."],
