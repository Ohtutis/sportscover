...
export const cards: CardRecord[] = [
  ...
  // Unlisted: the page opens from the QR/ID only and is not indexed.
  {
    cardId: "GDE-FS-FTB-2026-80",
    athleteId: "gde-fs-ftb-2026-80",
    firstName: "Avery",
    lastName: "O'Neal",
    jerseyNumber: "80",
    position: "Wide Receiver",
    team: "Grove City Dawgs",
    teamColors: { primary: "#1F2A5C", secondary: "#C8102E" },
    season: "2026",
    stats: [],
    sportCode: "FTB",
    styleName: "Fire & Smoke",
    playerHighlight: "September Player of the Week",
    createdAt: "2026-09-20",
    visibility: "unlisted",
    channel: "etsy",

    // A 16-year-old varsity player in a numbered sport: #80 is a real shirt number, printed on the
    // card front, the back and the certificate, so /c must print it too (`showsJerseyNumber`).
    // This entry was copied from the tennis record above it and carried "adult" across, which
    // silently dropped the "#". The band is what decides it — set it from the athlete, not the row.
    ageBand: "minor",
  },
  {
  ...
  {
    // Chrome All-Star lead card for the ice hockey listing. The QR printed on the card back and
    // on listing slides 05 / 17 encodes this id, so it has to resolve. Data read off the card art
    // itself (Figma `uvGQg19b8hLDwq2Jc9vBvB`, Chrome All-Star BACK).
    cardId: "GDE-CA-ICH-2026-17",
    athleteId: "nolan-reid",
    firstName: "Nolan",
    lastName: "Reid",
    jerseyNumber: "17",
    position: "Center",
    team: "Northgate Anvils",
    teamColors: { primary: "#12284B", secondary: "#C8102E" },
    season: "2026",
    classOf: "2028",
    stats: [
      { label: "G", value: "21" },
  ...
  {
    // Stadium Night lead card for the ice hockey POSTER listing (slides 05 / 17 carry this id).
  ...
  {
    // Signature Spotlight lead card for the gymnastics CARD listing. Numberless sport: the 01 in the id is the printed edition number.
    cardId: "GDE-SS-GYM-2026-01",
    athleteId: "sofia-marchetti",
    firstName: "Sofia",
    lastName: "Marchetti",
    jerseyNumber: "01",
    position: "All-Around",
    team: "Willow Bend Swifts",
    teamColors: { primary: "#6FA8DC", secondary: "#1B3A5C" },
    season: "2026",
    classOf: "2031",
    stats: [
      { label: "AA", value: "38.2" },
      { label: "BEAM", value: "9.70" },
      { label: "VAULT", value: "9.65" },
    ],
    playerHighlight: "Beam is her event \u00b7 9.7 season best at thirteen.",
    sportCode: "GYM",
    styleName: "Signature Spotlight",
    createdAt: "2026-09-14",
    isFictional: true,
  ...
  {
    // Heritage lead card for the gymnastics POSTER listing.
  ...
  {
    // Prism Rush lead card for the pickleball CARD listing. Pickleball wears no number (sports.ts corrected 2026-09-14).
    cardId: "GDE-PR-PKB-2026-02",
    athleteId: "nadia-rahimi",
    firstName: "Nadia",
    lastName: "Rahimi",
    jerseyNumber: "02",
    position: "Singles",
    team: "Copperline Kingfishers",
    teamColors: { primary: "#8C5A2B", secondary: "#F2E9DC" },
    season: "2026",
    classOf: "2028",
    stats: [
      { label: "WINS", value: "31" },
      { label: "TITLE", value: "3" },
      { label: "RATING", value: "4.25" },
    ],
    playerHighlight: "Junior singles champion \u00b7 4.25 rated at sixteen.",
    sportCode: "PKB",
  ...
  {
    // Chrome All-Star lead card for the pickleball POSTER listing.
  ...
  {
    // Chrome All-Star lead card for the tennis CARD listing.
    cardId: "GDE-CA-TEN-2026-01",
    athleteId: "arun-devarajan",
    firstName: "Arun",
    lastName: "Devarajan",
    jerseyNumber: "01",
    position: "Singles",
    team: "Highfield Herons",
    teamColors: { primary: "#17A398", secondary: "#0B2E2B" },
    season: "2026",
    classOf: "2029",
    stats: [
      { label: "WINS", value: "24" },
    ...
    playerHighlight: "24-4 at first singles \u00b7 never dropped a home match.",
    sportCode: "TEN",
    styleName: "Chrome All-Star",
    createdAt: "2026-09-14",
    isFictional: true,
  ...
  {
    // Signature Spotlight lead card for the tennis POSTER listing.
  ...
  {
    // Heritage lead card for the golf CARD listing.
    ...
    jerseyNumber: "01",
    position: "Varsity",
    team: "Pinewick Osprey",
    teamColors: { primary: "#5D6B2A", secondary: "#EDE6D6" },
    season: "2026",
    classOf: "2027",
    stats: [
      { label: "AVG", value: "74.2" },
      { label: "LOW", value: "68" },
      { label: "TOP 10", value: "6" },
    ],
    playerHighlight: "Sub-75 scoring average \u00b7 six top-ten finishes.",
    sportCode: "GLF",
    styleName: "Heritage",
    createdAt: "2026-09-14",
    isFictional: true,
  ...
  {
    // Stadium Night lead card for the golf POSTER listing.
  ...
  // card:new inserts above
  {
    ...
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Fire & Smoke` mode), not inferred.
    cardId: "GDE-FS-LAX-2026-22",
    athleteId: "reese-callahan",
    firstName: "Reese",
    lastName: "Callahan",
    jerseyNumber: "22",
    position: "Midfield",
    team: "Ash Grove Foxes",
    teamColors: { primary: "#23262B", secondary: "#E8A33D" },
    season: "2026",
    classOf: "2028",
    stats: [
    ...
    playerHighlight: "Draw specialist \u00b7 led the Foxes in ground balls.",
    sportCode: "LAX",
    styleName: "Fire & Smoke",
    createdAt: "2026-09-20",
    isFictional: true,
  ...
  {
    // Prism Rush lead card for the lacrosse POSTER listing. The QR on the card back and on listing
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Prism Rush` mode), not inferred.
  ...
  {
    // Prism Rush lead card for the track field CARD listing. The QR on the card back and on listing
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Prism Rush` mode), not inferred.
    cardId: "GDE-PR-TRK-2026-08",
    athleteId: "imani-whitfield",
    firstName: "Imani",
    lastName: "Whitfield",
    jerseyNumber: "8",
    position: "Sprints",
    team: "Redstone Flyers",
    teamColors: { primary: "#C8A200", secondary: "#2B2B2B" },
    season: "2026",
    classOf: "2028",
    stats: [
      { label: "100M", value: "11.94" },
      { label: "200M", value: "24.31" },
      { label: "LJ", value: "5.62" },
    ],
    playerHighlight: "School record in the 100 \u00b7 anchors the relay.",
    sportCode: "TRK",
    styleName: "Prism Rush",
    createdAt: "2026-09-20",
    isFictional: true,
  ...
  {
    // Fire & Smoke lead card for the track field POSTER listing. The QR on the card back and on listing
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Fire & Smoke` mode), not inferred.
  ...
  {
    // Stadium Night lead card for the swimming CARD listing. The QR on the card back and on listing
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Stadium Night` mode), not inferred.
    cardId: "GDE-SN-SWM-2026-01",
    athleteId: "nora-lindqvist",
    firstName: "Nora",
    lastName: "Lindqvist",
    jerseyNumber: "01",
    position: "Freestyle",
    team: "Bayline Marlins",
    teamColors: { primary: "#1F4EA1", secondary: "#FFFFFF" },
    season: "2026",
    classOf: "2028",
    stats: [
      { label: "50 FR", value: "23.41" },
      { label: "100 FR", value: "51.28" },
      { label: "200 FR", value: "1:52" },
    ],
    playerHighlight: "Sprint freestyle \u00b7 four school records this season.",
    sportCode: "SWM",
    styleName: "Stadium Night",
    createdAt: "2026-09-20",
    isFictional: true,
  ...
  {
    // Signature Spotlight lead card for the swimming POSTER listing. The QR on the card back and on listing
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Signature Spotlight` mode), not inferred.
  ...
  {
    // Signature Spotlight lead card for the other sport CARD listing. The QR on the card back and on listing
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Signature Spotlight` mode), not inferred.
    cardId: "GDE-SS-OTH-2026-12",
    athleteId: "sam-okonkwo",
    firstName: "Sam",
    lastName: "Okonkwo",
    jerseyNumber: "12",
    position: "Street",
    team: "Slate Creek Sentinels",
    teamColors: { primary: "#5C6672", secondary: "#E4B33C" },
    season: "2026",
    classOf: "2028",
    stats: [
      { label: "BEST", value: "86.4" },
      { label: "PODIUM", value: "5" },
      { label: "COMPS", value: "12" },
    ],
    playerHighlight: "Street skater \u00b7 lands it or runs it back, every time.",
    sportCode: "OTH",
    styleName: "Signature Spotlight",
    createdAt: "2026-09-20",
    isFictional: true,
  ...
  {
    // Chrome All-Star lead card for the other sport POSTER listing. The QR on the card back and on listing
    // slides 05 / 17 encodes this id, so it has to resolve. Id read from the sport file's
    // Style collection (`Chrome All-Star` mode), not inferred.
